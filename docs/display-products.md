...
In the default picker sidebar, selected products can be reordered with **Move up** and **Move down** controls. Reordering uses a short transition and highlight so editors can clearly track where the moved product lands.
