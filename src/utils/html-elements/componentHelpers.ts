...
const componentHelpers: ComponentHelper[] = [
  ...
  {
    html_code: `<section> <div class="pbx-w-full md:pbx-pt-2 md:pbx-pb-2 pbx-pt-4 pbx-pb-4 lg:pbx-px-4 pbx-px-2"> <div class="pbx-mx-auto pbx-max-w-7xl"> <div class="pbx-flex pbx-justify-start pbx-gap-4"> <div class="pbx-flex pbx-items-center pbx-font-medium pbx-text-white pbx-bg-green-600" id="linktree"> <span> <a target="_blank" rel="noopener noreferrer nofollow" href="https://www.google.com">Link to landing page</a> </span> </div> <div class="pbx-flex pbx-items-center pbx-font-medium pbx-text-white pbx-bg-green-600" id="linktree"> <span> <a target="_blank" rel="noopener noreferrer nofollow" href="https://www.google.com">Link to landing page</a> </span> </div> </div> </div> </div> </section>`,
    id: null,
  ...
  {
    html_code: `<section> <div class="pbx-w-full md:pbx-pt-2 md:pbx-pb-2 pbx-pt-4 pbx-pb-4 lg:pbx-px-4 pbx-px-2"> <div class="pbx-mx-auto pbx-max-w-7xl"> <div class="pbx-flex pbx-justify-center pbx-gap-4"> <div class="pbx-flex pbx-items-center pbx-font-medium pbx-text-white pbx-bg-green-600" id="linktree"> <span> <a target="_blank" rel="noopener noreferrer nofollow" href="https://www.google.com">Link to landing page</a> </span> </div> <div class="pbx-flex pbx-items-center pbx-font-medium pbx-text-white pbx-bg-green-600" id="linktree"> <span> <a target="_blank" rel="noopener noreferrer nofollow" href="https://www.google.com">Link to landing page</a> </span> </div> </div> </div> </div> </section>`,
    id: null,
  ...
  {
    html_code: `<section> <div class="pbx-w-full md:pbx-pt-2 md:pbx-pb-2 pbx-pt-4 pbx-pb-4 lg:pbx-px-4 pbx-px-2"> <div class="pbx-mx-auto pbx-max-w-7xl"> <div class="pbx-flex pbx-justify-end pbx-gap-4"> <div class="pbx-flex pbx-items-center pbx-font-medium pbx-text-white pbx-bg-green-600" id="linktree"> <span> <a target="_blank" rel="noopener noreferrer nofollow" href="https://www.google.com">Link to landing page</a> </span> </div> <div class="pbx-flex pbx-items-center pbx-font-medium pbx-text-white pbx-bg-green-600" id="linktree"> <span> <a target="_blank" rel="noopener noreferrer nofollow" href="https://www.google.com">Link to landing page</a> </span> </div> </div> </div> </div> </section>`,
    id: null,
