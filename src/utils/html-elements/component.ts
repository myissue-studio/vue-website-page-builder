  ...
  <g>
    ...
    <path class="cls-1" d="M336.83,5.27c.2-.22.37-.42.52-.62.14-.2.25-.4.32-.6.07-.2.11-.41.11-.64,0-.16-.03-.32-.09-.47-.06-.16-.15-.3-.28-.43s-.27-.23-.45-.31c-.18-.08-.38-.11-.61-.11-.32,0-.6.07-.83.22-.23.15-.41.36-.53.64-.12.28-.19.6-.19.97h-1.4c0-.6.11-1.13.34-1.6.23-.47.57-.84,1.01-1.1.45-.27.99-.4,1.62-.4.49,0,.91.08,1.27.23.36.16.66.36.89.61.24.25.41.52.53.82.12.3.18.58.18.86,0,.44-.11.86-.32,1.27-.22.41-.5.77-.84,1.09l-2.38,2.34h3.64v1.32h-6.41l3.89-4.09Z"/>
        ...
        },
        {
          ...
          html_code: `<section><div class="pbx-myPrimaryGap pbx-grid pbx-grid-cols-1 sm:pbx-grid-cols-2 lg:pbx-grid-cols-2"> <img class="pbx-object-cover pbx-w-full pbx-object-top pbx-aspect-square" src="${getPlaceholderImageDataUrl()}" alt="provider"/> <div class="pbx-mx-auto pbx-px-6 pbx-py-12"> <div class="pbx-break-words pbx-text-2xl lg:pbx-text-4xl pbx-font-medium"> <h2>Start customizing by editing this default text directly in the editor.</h2> </div> <div class="pbx-pt-12 pbx-pb-4"> <p>Start customizing by editing this default text directly in the editor. Start customizing by editing this default text directly in the editor.</p> </div> <div class="pbx-font-semibold pbx-py-4"> <p> <a target="_blank" rel="noopener noreferrer nofollow" href="https://www.google.com" >Layouts and visual.</a > </p> </div> </div> </div></section>`,
          category: 'Call To Action',
          cover_image: `
