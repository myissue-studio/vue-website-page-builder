...
const component: Components[] = [
  {
    components: {
      data: [
        ...
        {
          title: 'Image Slider',
          html_code: `<section><style>.pbx-isl-t{display:flex;overflow-x:auto;scroll-snap-type:x mandatory;scroll-behavior:smooth;-webkit-overflow-scrolling:touch;scrollbar-width:none;-ms-overflow-style:none}.pbx-isl-t::-webkit-scrollbar{display:none}@keyframes pbx-isl-r{0%{margin-left:0;animation-timing-function:step-end}33%{margin-left:-100%;animation-timing-function:step-end}66%{margin-left:-200%;animation-timing-function:step-end}99%{margin-left:0}}[data-isl][data-isl-auto] .pbx-isl-t{overflow:hidden!important;scroll-snap-type:none!important;pointer-events:none}[data-isl][data-isl-auto] .pbx-isl-t>div:first-child{animation:pbx-isl-r 9s infinite}.pbx-isl-dot{display:inline-block;width:0.5rem;height:0.5rem;border-radius:50%;background:rgba(255,255,255,0.4);cursor:pointer}.pbx-isl-nums{display:none;gap:0.75rem}.pbx-isl-nums span{font-size:1.25rem;font-weight:700;color:#fff;text-shadow:0 1px 4px rgba(0,0,0,0.7);cursor:pointer;min-width:1.5rem;text-align:center}[data-pagebuilder-content] .pbx-isl-nums{display:flex}[data-pagebuilder-content] .pbx-isl-nums span{opacity:0.4;transition:all 0.2s}[data-isl-active="0"] .pbx-isl-nums span:nth-child(1),[data-isl-active="1"] .pbx-isl-nums span:nth-child(2),[data-isl-active="2"] .pbx-isl-nums span:nth-child(3){opacity:1;background:rgba(255,255,255,0.9);color:#111;border-radius:9999px;padding:0.1rem 0.55rem;text-shadow:none}</style>\n<div class="pbx-pt-6 pbx-pb-6 md:pbx-pt-16 md:pbx-pb-16 lg:pbx-px-4 pbx-px-2"><div class="pbx-mx-auto pbx-max-w-7xl"><div data-pb-no-select style="position:relative;border-radius:0.5rem;overflow:hidden" data-isl><div class="pbx-isl-t"><div style="min-width:100%;scroll-snap-align:start"><img src="${getPlaceholderImageDataUrl()}" style="width:100%;aspect-ratio:16/9;object-fit:cover;display:block" alt="Slide 1"></div><div style="min-width:100%;scroll-snap-align:start"><img src="${getPlaceholderImageDataUrl()}" style="width:100%;aspect-ratio:16/9;object-fit:cover;display:block" alt="Slide 2"></div><div style="min-width:100%;scroll-snap-align:start"><img src="${getPlaceholderImageDataUrl()}" style="width:100%;aspect-ratio:16/9;object-fit:cover;display:block" alt="Slide 3"></div></div><div data-pb-no-select style="position:absolute;bottom:0.75rem;left:50%;transform:translateX(-50%);display:flex;flex-direction:column;align-items:center;gap:0.35rem;z-index:10"><div class="pbx-isl-nums"><span style="opacity:1;background:rgba(255,255,255,0.9);color:#111;border-radius:9999px;padding:0.1rem 0.55rem;text-shadow:none" onclick="(function(d,e){e.stopPropagation();var c=d.closest('[data-isl]');var t=c.querySelector('.pbx-isl-t');if(c.hasAttribute('data-isl-auto'))c.removeAttribute('data-isl-auto');var ns=c.querySelectorAll('.pbx-isl-nums span');ns.forEach(function(s,i){s.style.opacity=i===0?'1':'0.4';s.style.background=i===0?'rgba(255,255,255,0.9)':'';s.style.borderRadius=i===0?'9999px':'';s.style.padding=i===0?'0.1rem 0.55rem':'';s.style.color=i===0?'#111':'#fff';s.style.textShadow=i===0?'none':'';});var ds=c.querySelectorAll('.pbx-isl-dot');ds.forEach(function(dot,i){dot.style.background=i===0?'rgba(255,255,255,1)':'rgba(255,255,255,0.4)';});setTimeout(function(){t.scrollTo({left:0,behavior:'smooth'});var img=t.children[0].querySelector('img');if(img)img.click();},16)})(this,event)">1</span><span onclick="(function(d,e){e.stopPropagation();var c=d.closest('[data-isl]');var t=c.querySelector('.pbx-isl-t');if(c.hasAttribute('data-isl-auto'))c.removeAttribute('data-isl-auto');var ns=c.querySelectorAll('.pbx-isl-nums span');ns.forEach(function(s,i){s.style.opacity=i===1?'1':'0.4';s.style.background=i===1?'rgba(255,255,255,0.9)':'';s.style.borderRadius=i===1?'9999px':'';s.style.padding=i===1?'0.1rem 0.55rem':'';s.style.color=i===1?'#111':'#fff';s.style.textShadow=i===1?'none':'';});var ds=c.querySelectorAll('.pbx-isl-dot');ds.forEach(function(dot,i){dot.style.background=i===1?'rgba(255,255,255,1)':'rgba(255,255,255,0.4)';});setTimeout(function(){t.scrollTo({left:t.offsetWidth,behavior:'smooth'});var img=t.children[1].querySelector('img');if(img)img.click();},16)})(this,event)">2</span><span onclick="(function(d,e){e.stopPropagation();var c=d.closest('[data-isl]');var t=c.querySelector('.pbx-isl-t');if(c.hasAttribute('data-isl-auto'))c.removeAttribute('data-isl-auto');var ns=c.querySelectorAll('.pbx-isl-nums span');ns.forEach(function(s,i){s.style.opacity=i===2?'1':'0.4';s.style.background=i===2?'rgba(255,255,255,0.9)':'';s.style.borderRadius=i===2?'9999px':'';s.style.padding=i===2?'0.1rem 0.55rem':'';s.style.color=i===2?'#111':'#fff';s.style.textShadow=i===2?'none':'';});var ds=c.querySelectorAll('.pbx-isl-dot');ds.forEach(function(dot,i){dot.style.background=i===2?'rgba(255,255,255,1)':'rgba(255,255,255,0.4)';});setTimeout(function(){t.scrollTo({left:t.offsetWidth*2,behavior:'smooth'});var img=t.children[2].querySelector('img');if(img)img.click();},16)})(this,event)">3</span></div><div style="display:flex;gap:0.4rem"><span class="pbx-isl-dot" style="background:rgba(255,255,255,1)" onclick="(function(d,e){e.stopPropagation();var c=d.closest('[data-isl]');var t=c.querySelector('.pbx-isl-t');if(c.hasAttribute('data-isl-auto'))c.removeAttribute('data-isl-auto');var ns=c.querySelectorAll('.pbx-isl-nums span');ns.forEach(function(s,i){s.style.opacity=i===0?'1':'0.4';s.style.background=i===0?'rgba(255,255,255,0.9)':'';s.style.borderRadius=i===0?'9999px':'';s.style.padding=i===0?'0.1rem 0.55rem':'';s.style.color=i===0?'#111':'#fff';s.style.textShadow=i===0?'none':'';});var ds=c.querySelectorAll('.pbx-isl-dot');ds.forEach(function(dot,i){dot.style.background=i===0?'rgba(255,255,255,1)':'rgba(255,255,255,0.4)';});setTimeout(function(){t.scrollTo({left:0,behavior:'smooth'});var img=t.children[0].querySelector('img');if(img)img.click();},16)})(this,event)"></span><span class="pbx-isl-dot" onclick="(function(d,e){e.stopPropagation();var c=d.closest('[data-isl]');var t=c.querySelector('.pbx-isl-t');if(c.hasAttribute('data-isl-auto'))c.removeAttribute('data-isl-auto');var ns=c.querySelectorAll('.pbx-isl-nums span');ns.forEach(function(s,i){s.style.opacity=i===1?'1':'0.4';s.style.background=i===1?'rgba(255,255,255,0.9)':'';s.style.borderRadius=i===1?'9999px':'';s.style.padding=i===1?'0.1rem 0.55rem':'';s.style.color=i===1?'#111':'#fff';s.style.textShadow=i===1?'none':'';});var ds=c.querySelectorAll('.pbx-isl-dot');ds.forEach(function(dot,i){dot.style.background=i===1?'rgba(255,255,255,1)':'rgba(255,255,255,0.4)';});setTimeout(function(){t.scrollTo({left:t.offsetWidth,behavior:'smooth'});var img=t.children[1].querySelector('img');if(img)img.click();},16)})(this,event)"></span><span class="pbx-isl-dot" onclick="(function(d,e){e.stopPropagation();var c=d.closest('[data-isl]');var t=c.querySelector('.pbx-isl-t');if(c.hasAttribute('data-isl-auto'))c.removeAttribute('data-isl-auto');var ns=c.querySelectorAll('.pbx-isl-nums span');ns.forEach(function(s,i){s.style.opacity=i===2?'1':'0.4';s.style.background=i===2?'rgba(255,255,255,0.9)':'';s.style.borderRadius=i===2?'9999px':'';s.style.padding=i===2?'0.1rem 0.55rem':'';s.style.color=i===2?'#111':'#fff';s.style.textShadow=i===2?'none':'';});var ds=c.querySelectorAll('.pbx-isl-dot');ds.forEach(function(dot,i){dot.style.background=i===2?'rgba(255,255,255,1)':'rgba(255,255,255,0.4)';});setTimeout(function(){t.scrollTo({left:t.offsetWidth*2,behavior:'smooth'});var img=t.children[2].querySelector('img');if(img)img.click();},16)})(this,event)"></span></div></div></div></div></div>\n</section>`,
          category: 'Sliders',
          cover_image: null,
        },
        {
