    ...
    components: {
      data: [
        ...
        },
        {
          ...
          html_code: `<section>\n<div class="pbx-pt-6 pbx-pb-6 md:pbx-pt-16 md:pbx-pb-16 lg:pbx-px-4 pbx-px-2"><div class="pbx-mx-auto pbx-max-w-7xl"><div class="pbx-myPrimaryGap pbx-grid pbx-grid-cols-1 sm:pbx-grid-cols-3 lg:pbx-grid-cols-3"><div class="pbx-bg-gray-50 pbx-rounded-xl pbx-p-8"><p style="font-size:1.125rem;font-style:italic;margin:0 0 1.5rem;color:#1f2937">"Start customizing by editing this testimonial text directly in the editor. This is a great product."</p><div style="display:flex;align-items:center;gap:0.75rem"><img src="${getPlaceholderImageDataUrl()}" class="pbx-block pbx-inset-0 pbx-object-top pbx-d pbx-min-d pbx-max-d lg:pbx-w-10 lg:pbx-h-10 lg:pbx-min-w-10 lg:pbx-max-w-10 pbx-w-10 pbx-h-10 pbx-min-w-10 pbx-max-w-10 pbx-object-cover pbx-rounded-full" alt="Avatar"><div><p style="font-weight:600;margin:0;font-size:0.875rem">Full Name</p><p style="color:#6b7280;margin:0;font-size:0.75rem">Job Title</p></div></div></div><div class="pbx-bg-gray-50 pbx-rounded-xl pbx-p-8"><p style="font-size:1.125rem;font-style:italic;margin:0 0 1.5rem;color:#1f2937">"Start customizing by editing this testimonial text directly in the editor. Highly recommended."</p><div style="display:flex;align-items:center;gap:0.75rem"><img src="${getPlaceholderImageDataUrl()}" class="pbx-block pbx-inset-0 pbx-object-top pbx-d pbx-min-d pbx-max-d lg:pbx-w-10 lg:pbx-h-10 lg:pbx-min-w-10 lg:pbx-max-w-10 pbx-w-10 pbx-h-10 pbx-min-w-10 pbx-max-w-10 pbx-object-cover pbx-rounded-full" alt="Avatar"><div><p style="font-weight:600;margin:0;font-size:0.875rem">Full Name</p><p style="color:#6b7280;margin:0;font-size:0.75rem">Job Title</p></div></div></div><div class="pbx-bg-gray-50 pbx-rounded-xl pbx-p-8"><p style="font-size:1.125rem;font-style:italic;margin:0 0 1.5rem;color:#1f2937">"Start customizing by editing this testimonial text directly in the editor. Excellent experience overall."</p><div style="display:flex;align-items:center;gap:0.75rem"><img src="${getPlaceholderImageDataUrl()}" class="pbx-block pbx-inset-0 pbx-object-top pbx-d pbx-min-d pbx-max-d lg:pbx-w-10 lg:pbx-h-10 lg:pbx-min-w-10 lg:pbx-max-w-10 pbx-w-10 pbx-h-10 pbx-min-w-10 pbx-max-w-10 pbx-object-cover pbx-rounded-full" alt="Avatar"><div><p style="font-weight:600;margin:0;font-size:0.875rem">Full Name</p><p style="color:#6b7280;margin:0;font-size:0.75rem">Job Title</p></div></div></div></div></div></div>\n</section>`,
          category: 'Sliders',
          cover_image: null,
        },
      ],
