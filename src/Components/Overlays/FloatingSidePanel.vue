...
<template>
  <teleport to="body">
    <transition name="popup-fade">
      <div v-if="showSidebarPanel" class="pbx-fixed pbx-inset-0 pbx-z-[9999]">
        <!-- Overlay -->
        <div
        ...
        <div
          class="pbx-font-sans pbx-fixed pbx-top-0 pbx-rounded-3xl pbx-py-2 pbx-px-2 pbx-border pbx-border-gray-200 pbx-max-h-[80vh] lg:pbx-min-h-[98%] pbx-min-h-[80vh] lg:pbx-min-w-96 lg:pbx-w-96 pbx-w-[96%] pbx-overflow-y-auto pbx-z-50 pbx-bg-white lg:pbx-mt-2 pbx-mt-2 pbx-bg-white/70 pbx-backdrop-blur-md"
          :class="[
