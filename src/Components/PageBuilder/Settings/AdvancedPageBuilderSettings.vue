...
<template>
  <div>
    <div>
      <!-- tabbar start -->
      <div
        class="pbx-mb-4 pbx-flex pbx-justify-start pbx-items-center pbx-gap-2 pbx-border-0 pbx-border-solid pbx-border-b pbx-border-gray-200 pbx-pb-4 pbx-overflow-x-auto pbx-pt-2"
      >
