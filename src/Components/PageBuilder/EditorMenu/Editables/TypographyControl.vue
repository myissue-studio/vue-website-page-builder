  ...
  >
    ...
    <template #content>
      ...
      <template v-if="props.splitBasicAdvanced">
        ...
        <button
          type="button"
          class="pbx-mt-2 pbx-flex pbx-w-full pbx-items-center pbx-justify-between pbx-rounded-lg pbx-border pbx-border-solid pbx-border-gray-200 pbx-bg-gray-50 pbx-px-3 pbx-py-2 pbx-font-sans pbx-text-sm pbx-font-medium pbx-text-gray-700 hover:pbx-bg-gray-100"
        ...
        <div v-if="showAdvancedTypography" class="pbx-mt-2">
          <div class="pbx-my-2 pbx-py-2">
