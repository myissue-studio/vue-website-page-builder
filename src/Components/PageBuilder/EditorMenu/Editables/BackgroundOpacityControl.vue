  ...
  <div class="pbx-editorFieldGroup">
    <Listbox as="div" v-model="opacityVueModel">
      <div class="pbx-relative">
        ...
        >
          <ListboxOptions
            class="pbx-absolute pbx-z-10 pbx-mt-1 pbx-max-h-72 pbx-w-full pbx-overflow-auto pbx-rounded-md pbx-bg-white pbx-text-base pbx-shadow-lg pbx-ring-1 pbx-ring-black pbx-ring-opacity-5 focus:pbx-outline-none sm:pbx-text-sm pbx-list-none pbx-p-0 pbx-m-0"
          >
            <ListboxOption
              as="template"
