  ...
  >
    <TransitionGroup name="pbx-toast" tag="div" class="pbx-flex pbx-flex-col pbx-gap-2">
      ...
      >
        ...
        <button
          type="button"
          class="pbx-h-6 pbx-w-6 pbx-cursor-pointer pbx-rounded-full pbx-flex pbx-items-center pbx-border-none pbx-justify-center pbx-bg-gray-50 pbx-aspect-square hover:pbx-bg-myPrimaryButtonColor hover:pbx-text-myPrimaryButtonTextColor focus-visible:pbx-outline-none focus-visible:pbx-ring-2 focus-visible:pbx-ring-myPrimaryLinkColor/30 pbx-text-black"
          :aria-label="'Close'"
